...
#+LaTeX_HEADER: \setlength{\parindent}{0cm} % Default is 15pt.
#+LaTeX_HEADER: \setlength{\parskip}{1em}
#+LaTeX_HEADER: \usepackage[a5paper, hmargin=2.0cm,vmargin=2.0cm]{geometry}
#+LaTeX_HEADER: \usepackage{tocloft}
#+LaTeX_HEADER: \setlength{\cftsubsecnumwidth}{3em}
